...
<body>
    ...
    <div class="alert alert-secondary" role="alert">
        <h4 class="text-center">Upload Image for Designer Explore Section</h4>
    </div>
    <div class="container col-12 m-5">
       <div class="col-6 m-auto">
        ...
        if(isset($_POST['btn_img']))
        {
            ...
            $sql = "INSERT INTO `designerimages`(`image`, `name`, `description`) 
        ...
        <form action="Deyt.php" method="post" class="form-control" enctype="multipart/form-data">
        ...
        <table class="table text-center">
            ...
            $sql2 = "SELECT * FROM `designerimages` WHERE 1";
            ...
            <tr>
                ...
                <td><a href="deDelete.php?id=<?php echo $fetch['id'] ?>" class="btn btn-outline-danger">Delete</a></td>
            </tr>
